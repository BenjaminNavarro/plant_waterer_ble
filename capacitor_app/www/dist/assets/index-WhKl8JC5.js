 ...
 */const Ce=vi(class extends yi{constructor(t){if(super(t),t.type!==Gt.PROPERTY&&t.type!==Gt.ATTRIBUTE&&t.type!==Gt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Xo(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===Et||e===et)return e;const i=t.element,s=t.name;if(t.type===Gt.PROPERTY){if(e===i[s])return Et}else if(t.type===Gt.BOOLEAN_ATTRIBUTE){if(!!e===i.hasAttribute(s))return Et}else if(t.type===Gt.ATTRIBUTE&&i.getAttribute(s)===e+"")return Et;return Aa(t),e}});var ht=class extends T{constructor(){super(...arguments),this.formControlController=new ae(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new Ct(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return y`
    ...
    `}};ht.styles=[R,Se,ha];ht.dependencies={"sl-icon":J};a([$('input[type="checkbox"]')],ht.prototype,"input",2);a([P()],ht.prototype,"hasFocus",2);a([c()],ht.prototype,"title",2);a([c()],ht.prototype,"name",2);a([c()],ht.prototype,"value",2);a([c({reflect:!0})],ht.prototype,"size",2);a([c({type:Boolean,reflect:!0})],ht.prototype,"disabled",2);a([c({type:Boolean,reflect:!0})],ht.prototype,"checked",2);a([c({type:Boolean,reflect:!0})],ht.prototype,"indeterminate",2);a([Ne("checked")],ht.prototype,"defaultChecked",2);a([c({reflect:!0})],ht.prototype,"form",2);a([c({type:Boolean,reflect:!0})],ht.prototype,"required",2);a([c({attribute:"help-text"})],ht.prototype,"helpText",2);a([x("disabled",{waitUntilFirstUpdate:!0})],ht.prototype,"handleDisabledChange",1);a([x(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],ht.prototype,"handleStateChange",1);var za=D`
  :host {
    --track-width: 2px;
...
`,Ke=class extends T{constructor(){super(...arguments),this.localize=new W(this),this.separatorDir=this.localize.dir(),this.label=""}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="sl-breadcrumb-item");t.forEach((e,i)=>{const s=e.querySelector('[slot="separator"]');s===null?e.append(this.getSeparator()):s.hasAttribute("data-default")&&s.replaceWith(this.getSeparator()),i===t.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),y`
    ...
    `}};Ke.styles=[R,lc];Ke.dependencies={"sl-icon":J};a([$("slot")],Ke.prototype,"defaultSlot",2);a([$('slot[name="separator"]')],Ke.prototype,"separatorSlot",2);a([c()],Ke.prototype,"label",2);Ke.define("sl-breadcrumb");Y.define("sl-button");var cc=D`
  :host {
