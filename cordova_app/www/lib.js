...
async function readApi(endpoint, onSuccess = null, onError = null) {
    try {
...
async function writeApi(endpoint, data, onComplete = null) {
...
function init() {
    ...
    searchBtn.addEventListener('click', function () {
        ...
        var index = 0;
        ble.startScanWithOptions([], { scanMode: 'lowLatency' }, function (device) {
            console.log(device);
