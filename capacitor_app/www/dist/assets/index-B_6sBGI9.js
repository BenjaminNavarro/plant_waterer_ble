 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let $s=class extends yi{constructor(e){if(super(e),this.it=et,e.type!==Gt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===et||e==null)return this._t=void 0,this.it=e;if(e===Et)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};$s.directiveName="unsafeHTML",$s.resultType=1;const Ri=vi($s);var H=class extends T{constructor(){super(...arguments),this.formControlController=new ae(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new Ct(this,"help-text","label"),this.localize=new W(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.filled=!1,this.pill=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=t=>y`
      <sl-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`,te=class extends T{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("sl-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("sl-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return y`
    ...
    `}};te.styles=[R,cl];te.dependencies={"sl-icon":Z};a([P()],te.prototype,"checked",2);a([P()],te.prototype,"hasFocus",2);a([c()],te.prototype,"value",2);a([c({reflect:!0})],te.prototype,"size",2);a([c({type:Boolean,reflect:!0})],te.prototype,"disabled",2);a([x("checked")],te.prototype,"handleCheckedChange",1);a([x("disabled",{waitUntilFirstUpdate:!0})],te.prototype,"handleDisabledChange",1);te.define("sl-radio");var dl=D`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,se=class extends T{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){const t=y`
    ...
    `}};se.styles=[R,nc];se.dependencies={"sl-icon":Z};a([P()],se.prototype,"hasError",2);a([c()],se.prototype,"image",2);a([c()],se.prototype,"label",2);a([c()],se.prototype,"initials",2);a([c()],se.prototype,"loading",2);a([c({reflect:!0})],se.prototype,"shape",2);a([x("image")],se.prototype,"handleImageChange",1);se.define("sl-avatar");var lc=D`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
